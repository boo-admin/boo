...
func performTests(validator Validator, tests []Expect, t *testing.T) {
	for _, test := range tests {
		if validator.IsSatisfied(test.input) != test.expectedResult {
			t.Log(test.input, validator.IsSatisfied(test.input))
...
func TestIPAddr(t *testing.T) {
	...
	test_ipv4rangev1_with_ipaddrs := map[string]bool{
		"192.168.1.1-192.168.1.124": true,
		"127.0.0.1-127.0.0.1":       true,
		"10.10.90.12-10.10.90.212":  true,
		"10.10.90.212-10.10.90.12":  false,
		"10.10.9.1-10.10.90.12":     false,
	}

	test_ipv4rangev2_with_ipaddrs := map[string]bool{
		"192.168.1.1-192.168.1.124": true,
		"127.0.0.1-127.0.0.1":       true,
		"10.10.90.12-10.10.90.212":  true,
		"10.10.90.212-10.10.90.12":  false,
		"10.10.89.212-10.10.90.12":  true,
		"10.10.9.1-10.10.90.12":     true,
	}
	...
	runIPAddrTestfunc(t, IPv4RangeV1, test_ipv4rangev1_with_ipaddrs, "invalid (%s) ipv4rangev1")
	runIPAddrTestfunc(t, IPv4RangeV2, test_ipv4rangev2_with_ipaddrs, "invalid (%s) ipv4rangev2")
}
